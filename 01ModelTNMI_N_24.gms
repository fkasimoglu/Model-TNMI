...
sets
*indices and sets
        i  supply points  /i1*i6/
        j  stage1 stations /j1*j6/
        k  Stage2 stations /k1*k6/
        l  demand points  /l1*l6/
...
*** Enter total interdiction resources available below
TIR=30;
scalar
...
Display Z.l, y1.l, y2.l, y3.l, SA1,SA2,SA3,S;
